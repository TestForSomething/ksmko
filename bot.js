...
client.login("NDQ3MzYyMzAwNzk4Njk3NDcz.DnJUuA.D5zzhUdv3s0_3uumzrk8OXEGWW0"); // حط توكن البوت داخل 
...
message.guild.members.get(user.id).setVoiceChannel('480939317439496196'); // المكان الي راح ينحطوله بعد ما يصير لهم lock 
}   
} catch (error) {
console.log(error)
}
